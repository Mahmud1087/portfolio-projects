...
const ZX9Speaker = () => {
  return (
    <div className='container pt-24 overflow-hidden lg:pt-40'>
      <section className='relative w-full h-[41rem] sm:h-[55rem] lg:h-[29rem] rounded-lg bg-orange-200 z-10'>
        <AnimatedCircles />
        ...
        <article className='w-full h-full flex'>
          ...
          <div className='w-full h-full flex flex-col justify-center items-center text-center gap-8 mt-[7.5rem] sm:mt-28 lg:gap-5 lg:mt-0 lg:text-start lg:items-start lg:w-2/5'>
            <h1 className='text-4xl text-light-100 tracking-[3px] leading-[2.8rem] font-bold sm:leading-[4rem] sm:text-[3.5rem] lg:leading-10 lg:font-semibold lg:text-[2.3rem]'>
              ZX9 <br /> SPEAKER
            </h1>
            <p className='text-lg leading-8 text-[#ffffff9d] sm:text-2xl lg:leading-5 lg:text-sm'>
