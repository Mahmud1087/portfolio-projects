    ...
    >
      ...
      <aside className='relative container flex w-full'>
        <section className='hero_height w-full flex flex-col justify-center items-center text-center text-light-100 lg:items-start lg:text-start lg:w-2/5'>
          <h3 className='text-[#ffffff62] text-xs tracking-[10px] mb-5 sm:mb-7 sm:text-2xl lg:mb-5 lg:text-xs'>
            NEW PRODUCT
          </h3>
          <h1 className='text-[2rem] tracking-[3px] font-bold leading-[2.3rem] mb-6 sm:mb-10 sm:leading-[5rem] sm:text-7xl lg:mb-6 lg:leading-[3.3rem] lg:text-[2.9rem]'>
            XX99 MARK II <br />
            HEADPHONES
          </h1>
          <p className='text-[13px] text-[#ffffffb9] tracking-[1px] mb-10 leading-5 sm:mb-16 sm:leading-9 sm:text-[1.4rem] lg:mb-7 lg:leading-[25px] lg:text-[12.5px]'>
