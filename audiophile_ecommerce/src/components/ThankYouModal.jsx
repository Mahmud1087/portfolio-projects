  ...
  return (
    <div className='fixed h-screen w-screen top-0 left-0 bg-transparent'>
      <section className='fixed overflow-scroll w-full hero_height left-0 bg-[#00000060] sm:top-20'>
        <article className='relative z-50 h-full w-full flex justify-center container top-28 sm:top-32 lg:top-0 lg:overflow-hidden lg:grid lg:place-items-center'>
