  ...
  return (
    <div className='fixed h-screen w-screen top-0 left-0 bg-transparent'>
      <section className='fixed overflow-scroll w-full hero_height left-0 bg-[#00000060] sm:top-20'>
        <article className='relative z-50 h-full w-full flex justify-center container top-28 sm:top-32 lg:grid lg:place-items-center'>
          <div className='absolute bg-light-100 rounded-md py-8 px-6 flex flex-col justify-between w-full h-fit sm:py-9 sm:px-12 sm:h-[42rem] sm:w-[42rem] lg:py-7 lg:px-9 lg:h-[27rem] lg:w-[27rem]'>
            {cartList.length === 0 ? (
              ...
              <div className='flex flex-col'>
                ...
                <section className='flex w-full flex-col sm:h-48 sm:flex-row sm:py-0 lg:h-[6.7rem]'>
                  <div className='w-full rounded-t-lg bg-light-300 h-full flex flex-col justify-center py-6 sm:rounded-l-md sm:py-0 sm:w-3/5 lg:justify-start'>
                  ...
                  <div className='w-full rounded-b-lg bg-dark-300 h-[7rem] flex flex-col justify-center px-8 sm:h-full sm:py-0 sm:rounded-r-md sm:w-2/5 lg:px-4'>
